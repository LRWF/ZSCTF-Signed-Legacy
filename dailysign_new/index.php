...
if(isset($_POST['ok']))
{
    ...
    $ftoken = 'SELECT token FROM databasename';
    $rtv = mysqli_query($conn,$ftoken);
    ...
    {
        echo "<script>alert('token异常，签到失败！请重新扫描管理员的二维码签到！');location.href='".$_SERVER["HTTP_REFERER"]."';</script>";
    }
